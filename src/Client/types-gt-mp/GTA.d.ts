declare namespace GTA {
	...
	class Checkpoint {
		...
		Delete(): void;
		Exists(): boolean;
		Exists(checkpoint: GTA.Checkpoint): boolean;
	...
	class Entity {
		...
		constructor(handle: number);
		GetEntityType(handle: number): GTA.EntityType;
		ResetOpacity(): void;
	...
	class HandlingData {
		...
		GetByHash(handlingNameHash: number): GTA.HandlingData;
		GetByVehicleModel(vehicleModel: GTA.Model): GTA.HandlingData;
	...
	class Pickup {
		...
		Delete(): void;
		Exists(): boolean;
		Exists(pickup: GTA.Pickup): boolean;
