declare namespace GTA.Math {
	...
	class Quaternion {
		...
		Conjugate(value: GTA.Math.Quaternion): GTA.Math.Quaternion;
		...
		Euler(zaxis: number, xaxis: number, yaxis: number): GTA.Math.Quaternion;
		...
		RotateTransform(rotation: GTA.Math.Quaternion, point: GTA.Math.Vector3): GTA.Math.Vector3;
		RotateTransform(rotation: GTA.Math.Quaternion, point: GTA.Math.Vector3, center: GTA.Math.Vector3): GTA.Math.Vector3;
